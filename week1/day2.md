...
- [X] I know all 8 primitive types in Java (or equivalents in my language)
- [X] I can take input and print output without looking it up
- [X] I understand the difference between `print` and `println`
- [X] I know what widening and narrowing type casting mean
